...
enum PaymentOption { onDelivery, online }
  ...
  List<Step> generateList() {
    return [
            ...
            builder: (builderContext, setState) {
              return Row(
                children: [
                  GestureDetector(
                    onTap: () =>
                        setState(() => option = PaymentOption.onDelivery),
                    child: Row(
                      children: [
                        Radio<PaymentOption>(
                            groupValue: option,
                            value: PaymentOption.onDelivery,
                            onChanged: (value) {
                              setState(() {
      ...
      Step(
          ...
          content: (option == PaymentOption.onDelivery)
              ...
              setState(() {
                if (activeIndex < steps.length - 1) {
                  ...
                  orderProduct(context).then((b) {
                    Invoker.post("/api/v1/product/create-order/", true,
                        json.encode({})).then((a) {
