...
class Body extends StatefulWidget {
  Body({ Key? key, required this.password, required this.confirmPassword, required this.email }) : super(key: key);
          ...
          // child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Column(children: [
                  Text("Update Your Password ", style: headingStyle, ),
                ...
                OtpForm(password: widget.password, confirmPassword: widget.confirmPassword,),
  ...
  Row buildTimer() {
    return Row(
          ...
          children: [
            ...
            TweenAnimationBuilder(tween: Tween(begin: widget.value, end: 0),
             duration: const Duration(seconds: 59),
             builder: (context, value, child)=> Text("00:${(value as num).floor().toString().padLeft(2, '0')}",
